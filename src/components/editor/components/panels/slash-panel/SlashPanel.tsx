...
import DocumentIcon from '@/assets/icons/page.svg?react';
// import AIWriterIcon from '@/assets/slash_menu_icon_ai_writer.svg?react';
import BulletedListIcon from '@/assets/icons/bulleted_list.svg?react';
import CalloutIcon from '@/assets/icons/callout.svg?react';
import TodoListIcon from '@/assets/icons/todo.svg?react';
import CodeIcon from '@/assets/icons/inline_code.svg?react';
import DividerIcon from '@/assets/icons/slash_menu_icon_divider.svg?react';
import RefDocumentIcon from '@/assets/icons/ref_page.svg?react';
import EmojiIcon from '@/assets/icons/emoji.svg?react';
import FileIcon from '@/assets/icons/file.svg?react';
// import GridIcon from '@/assets/slash_menu_icon_grid.svg?react';
// import BoardIcon from '@/assets/slash_menu_icon_kanban.svg?react';
// import CalendarIcon from '@/assets/slash_menu_icon_calendar.svg?react';
import Heading1Icon from '@/assets/icons/h1.svg?react';
import Heading2Icon from '@/assets/icons/h2.svg?react';
import Heading3Icon from '@/assets/icons/h3.svg?react';
import ImageIcon from '@/assets/icons/image.svg?react';
import NumberedListIcon from '@/assets/icons/numbered_list.svg?react';
import OutlineIcon from '@/assets/icons/doc.svg?react';
import QuoteIcon from '@/assets/icons/quote.svg?react';
import TextIcon from '@/assets/icons/text.svg?react';
import ToggleListIcon from '@/assets/icons/toggle_list.svg?react';
import ToggleHeading1Icon from '@/assets/icons/toggle_h1.svg?react';
import ToggleHeading2Icon from '@/assets/icons/toggle_h2.svg?react';
import ToggleHeading3Icon from '@/assets/icons/toggle_h3.svg?react';
import AskAIIcon from '@/assets/icons/ai.svg?react';
import ContinueWritingIcon from '@/assets/icons/continue_writing.svg?react';
import FormulaIcon from '@/assets/icons/formula.svg?react';
