...
import AlignCenterSvg from '@/assets/icons/align_center.svg?react';
import AlignLeftSvg from '@/assets/icons/align_left.svg?react';
import AlignRightSvg from '@/assets/icons/align_right.svg?react';
